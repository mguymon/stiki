...
Stiki is aRails Engine for adding simple wiki support to site. Stiki is comprised of Spaces that have multiple Pages. A Page is 
comprised of a Title and Wiki Body.

Stiki is designed to work with twitter-bootstrap, but will work with any site with for sites that use compatible css.
